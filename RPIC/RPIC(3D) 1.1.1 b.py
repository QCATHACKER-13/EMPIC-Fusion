...
while t < (t_max + 1):
    ...
    for Nei in range(num_particles[0]):
        ...
        for Nej in range(1, num_particles[0]):
            ...
            if(not(Nei == Nej)):
                ...
                U, Ueex, Ueey, Ueez = ee_interaction.Up(-e, -e)
    ...
    for Npi in range(num_particles[1]):
        ...
        for Npj in range(1, num_particles[1]):
            ...
            if(not(Npi == Npj)):
                ...
                U, Uppx, Uppy, Uppz = pp_interaction.Up(e, e)
                ...
                pG = fusionProbability.gamow_factor(U)
                print(f"{Npi}    {Npj}    {pG}    {U*(1e6/e)}")
    ...
    for Np in range(num_particles[1]):
        ...
        for Ne in range(num_particles[0]):
            ...
            U, Upex, Upey, Upez = pe_interaction.Up(-e, e)
            ...
            pG = neutronProbability.gamow_factor(U)
            print(f"{Np}    {Ne}    {pG}    {U*(1e6/e)}")
