    ...
    for Na in range(num_particles[1]):
        ...
        for Nb in range(1, num_particles[1]):
            ...
            if(not(Na == Nb)):
                ...
                print(f"{no_step},           {listing_no},           {Na},           {Nb},           {fusion_no},           {collision_no},           {tunnel_prob},           {np.abs(tunnel_prob - prob_fuss)},           {rc},           {cross_sec},           {MB_dis} ,          {v_cm},           {v_r},           {U2/(e*np.power(10, 6))},           {(U_pp[Na][Nb]/(e*np.power(10, 6)))}")
