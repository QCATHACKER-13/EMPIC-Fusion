...
x_velocity = np.random.uniform(0, c0, num_particles)
y_velocity = np.random.uniform(0, c0, num_particles)
z_velocity = np.random.uniform(0, c0, num_particles)
...
#Magnetic Field Perpendicular in Electric Field
def B1(I0, a3, X, Y, Z):
