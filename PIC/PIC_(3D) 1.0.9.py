            ...
            for Nej in range(num_particles[0]):
                ...
                if (0 <= grid_xje < Nx) and (0 <= grid_yje < Ny) and (0 < grid_zje <= Nz):
                    ...
                    if not(Nei == Nej):
                        ...
                        U_ee[Nei][Nej] = np.sqrt(np.power(Uee_x[Nei][Nej], 2) + np.power(Uee_y[Nei][Nej], 2) + np.power(Uee_x[Nei][Nej], 2))
            ...
            for Npj in range(num_particles[0]):
                ...
                if (0 <= grid_xjp < Nx) and (0 <= grid_yjp < Ny) and (0 < grid_zjp <= Nz):
                    ...
                    if not(Npi == Npj):
                        ...
                        U_pp[Npi][Npj] = np.sqrt(np.power(Upp_x[Npi][Npj], 2) + np.power(Upp_y[Npi][Npj], 2) + np.power(Upp_x[Npi][Npj], 2))
        ...
        if (0 <= grid_xe < Nx) and (0 <= grid_ye < Ny) and (0 < grid_ze <= Nz):
            ...
            for Np in range(num_particles[1]):
                ...
                if (0 <= grid_xp < Nx) and (0 <= grid_yp < Ny) and (0 < grid_zp <= Nz):
                    ...
                    U_pe[Ne][Np] = np.sqrt(np.power(Upe_x[Ne][Np], 2) + np.power(Upe_y[Ne][Np], 2) + np.power(Upe_z[Ne][Np], 2))
